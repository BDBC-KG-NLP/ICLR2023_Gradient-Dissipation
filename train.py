...
class ModelArguments:
    ...
    output_size: float = field(
        default=768,
        metadata={"help": "Ootput size"}
    )

    lambdas: float = field(
        default=0.0,
        metadata={"help": "layers of gcnn"}
    )
    ...
    margin: float = field(
        default=0.15,
        metadata={"help": "The para number of margin loss"}
    )
    align_alpha: float = field(
        default=2,
        metadata={"help": "The para index number of align loss."}
    )
    uniform_t: float = field(
        default=2,
        metadata={"help": "The para number of uniform loss."}
    )
    logger_dir: str = field(
        default="",
        metadata={"help": "The log path of tensorboard."}
    )
...
def main():
    ...
    trainer.eval_test_pos_dataset, trainer.eval_train_dataset, \
    trainer.eval_test_dataset = None, None, None
