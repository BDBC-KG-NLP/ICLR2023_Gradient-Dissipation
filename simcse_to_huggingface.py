...
def main():
    ...
    parser.add_argument("--output_path", type=str, help="Maybe Temp Output Path is Needed")
    ...
    if args.output_path is not None:
        json.dump(config, open(os.path.join(args.output_path, "config.json"), "w"), indent=2)
    else:
